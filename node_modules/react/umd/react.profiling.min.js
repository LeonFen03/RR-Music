 ...
 */
(function(){'use strict';(function(b,w){"object"===typeof exports&&"undefined"!==typeof module?w(exports):"function"===typeof define&&define.amd?define(["exports"],w):(b=b||self,w(b.React={}))})(this,function(b){function w(a){if(null===a||"object"!==typeof a)return null;a=W&&a[W]||a["@@iterator"];return"function"===typeof a?a:null}function A(a){for(var c="https://reactjs.org/docs/error-decoder.html?invariant="+a,k=1;k<arguments.length;k++)c+="&args[]="+encodeURIComponent(arguments[k]);return"Minified React error #"+
a+"; visit "+c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function u(a,c,k){this.props=a;this.context=c;this.refs=X;this.updater=k||Y}function Z(){}function K(a,c,k){this.props=a;this.context=c;this.refs=X;this.updater=k||Y}function aa(a,c,k){var b,e={},ba=null,x=null;if(null!=c)for(b in void 0!==c.ref&&(x=c.ref),void 0!==c.key&&(ba=""+c.key),c)ca.call(c,b)&&!da.hasOwnProperty(b)&&(e[b]=c[b]);var d=arguments.length-2;if(1===d)e.children=
...
function(){la(V,0)};d={ReactCurrentDispatcher:g,ReactCurrentOwner:L,IsSomeRendererActing:{current:!1},ReactCurrentBatchConfig:J,assign:U,Scheduler:{__proto__:null,unstable_ImmediatePriority:1,unstable_UserBlockingPriority:2,unstable_NormalPriority:3,unstable_IdlePriority:5,unstable_LowPriority:4,unstable_runWithPriority:function(a,c){switch(a){case 1:case 2:case 3:case 4:case 5:break;default:a=3}var b=f;f=a;try{return c()}finally{f=b}},unstable_next:function(a){switch(f){case 1:case 2:case 3:var c=
3;break;default:c=f}var b=f;f=c;try{return a()}finally{f=b}},unstable_scheduleCallback:function(a,c,b){var d=t();"object"===typeof b&&null!==b?(b=b.delay,b="number"===typeof b&&0<b?d+b:d):b=d;switch(a){case 1:var e=-1;break;case 2:e=250;break;case 5:e=1073741823;break;case 4:e=1E4;break;default:e=5E3}e=b+e;a={id:Aa++,callback:c,priorityLevel:a,startTime:b,expirationTime:e,sortIndex:-1};b>d?(a.sortIndex=b,O(q,a),null===l(p)&&a===l(q)&&(y?(ia(z),z=-1):y=!0,T(Q,b-d))):(a.sortIndex=e,O(p,a),r||F||(r=
!0,R(S)));return a},unstable_cancelCallback:function(a){a.callback=null},unstable_wrapCallback:function(a){var c=f;return function(){var b=f;f=c;try{return a.apply(this,arguments)}finally{f=b}}},unstable_getCurrentPriorityLevel:function(){return f},unstable_shouldYield:ja,unstable_requestPaint:function(){},unstable_continueExecution:function(){r||F||(r=!0,R(S))},unstable_pauseExecution:function(){},unstable_getFirstCallbackNode:function(){return l(p)},get unstable_now(){return t},unstable_forceFrameRate:function(a){0>
a||125<a?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ta=0<a?Math.floor(1E3/a):5},unstable_Profiling:null}};b.Children={map:C,forEach:function(a,c,b){C(a,function(){c.apply(this,arguments)},b)},count:function(a){var c=0;C(a,function(){c++});return c},toArray:function(a){return C(a,function(a){return a})||[]},only:function(a){if(!M(a))throw Error(A(143));return a}};b.Component=u;b.PureComponent=K;b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=
d;b.cloneElement=function(a,c,b){if(null===a||void 0===a)throw Error(A(267,a));var d=U({},a.props),e=a.key,f=a.ref,k=a._owner;if(null!=c){void 0!==c.ref&&(f=c.ref,k=L.current);void 0!==c.key&&(e=""+c.key);if(a.type&&a.type.defaultProps)var g=a.type.defaultProps;for(h in c)ca.call(c,h)&&!da.hasOwnProperty(h)&&(d[h]=void 0===c[h]&&void 0!==g?g[h]:c[h])}var h=arguments.length-2;if(1===h)d.children=b;else if(1<h){g=Array(h);for(var l=0;l<h;l++)g[l]=arguments[l+2];d.children=g}return{$$typeof:v,type:a.type,
...
function(a,b){return g.current.useLayoutEffect(a,b)};b.useMemo=function(a,b){return g.current.useMemo(a,b)};b.useReducer=function(a,b,d){return g.current.useReducer(a,b,d)};b.useRef=function(a){return g.current.useRef(a)};b.useState=function(a){return g.current.useState(a)};b.useTransition=function(){return g.current.useTransition()};b.version="18.0.0-experimental-1a106bdc2"});
})();
